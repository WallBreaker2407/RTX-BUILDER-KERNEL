...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	then
		...
		msg "|| Cloning GCC ||"
		git clone --depth=1 https://github.com/fajar4561/gcc-arm64.git -b gcc-master gcc64
		git clone --depth=1 https://github.com/fajar4561/gcc-arm.git -b gcc-master gcc32
	fi
...
gen_zip() {
	...
	sed -i "s/kernel.made=.*/kernel.made=P.L.A.N.K.T.O.N @plankton86/g" anykernel.sh
	...
	curl --progress-bar -F document=@"$ZIPNAME" "https://api.telegram.org/bot$TOKEN/sendDocument" \
        ...
        <b>📝 Notes: </b>
        - <code>$VERSI_KENEL</code>

        <b>🔥 Status Release</b>
        #$NAMA #$JENIS #$VARIAN #$KBUILD_BUILD_VERSION"
